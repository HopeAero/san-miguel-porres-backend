...
export class CourseSchoolYearController {
  ...
  @ApiParam({ name: 'id', description: 'ID de la asignatura por año escolar a actualizar' })
  @Put(':id')
  async update(
  ...
  @ApiParam({ name: 'id', description: 'ID de la asignatura por año escolar a eliminar' })
  @Delete(':id')
